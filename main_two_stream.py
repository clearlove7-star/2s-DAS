...
#     """Helper function to calculate FLOPS for a given model and input tensor."""
#     with torch.no_grad():
#         flops = torchprofile.profile_macs(model, input_tensor)
#     return flops * 2  # MACC (Multiply-Accumulate) 等于 FLOPs的一半
...
#         self.decoder_params = decoder_params
    ...
    def test_single_video(self, video_idx, test_dataset, mode, device, model_path=None):  
        ...
        with torch.no_grad():
            ...
            min_len = min([i.shape[2] for i in output_RGB + output_FLOW])
            ...
            output = 0.6 * output_RGB + 0.4 * output_FLOW
...
if __name__ == '__main__':
    ...
    feature_dir_768 = os.path.join(root_data_dir, dataset_name, '768_features')
