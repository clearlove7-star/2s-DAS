...
class ASDiffusionModel(nn.Module):
    def __init__(self, input_dim, encoder_params, decoder_params, diffusion_params, num_classes, device):
    ...
    def model_predictions(self, backbone_feats, x, t):
        ...
        return pred_noise, x_start, flops
    ...
    def ddim_sample(self, video_feats, seed=None):
        ...
        for time, time_next in time_pairs:
            ...
            pred_noise, x_start, flops_decoder = self.model_predictions(backbone_feats, x_time, time_cond)
